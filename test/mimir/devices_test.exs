defmodule Mimir.DevicesTest do
  use Mimir.DataCase

  alias Mimir.Devices

  describe "devices" do
    alias Mimir.Devices.Device

    import Mimir.DevicesFixtures
    ...
    test "create_device/1 with valid data creates a device" do
      ...
      assert device.uuid == "7488a646-e31f-11e4-aace-600308960662"
    end
    ...
    test "update_device/2 with valid data updates the device" do
      ...
      assert device.uuid == "7488a646-e31f-11e4-aace-600308960668"
    end
